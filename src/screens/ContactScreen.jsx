...
export default function AboutScreen() {
  return (
    <ScrollView contentContainerStyle={styles.scrollViewContent}>
      <View style={{ ...styles.container, paddingBottom: 75 }}>
        ...
        <Text style={styles.textoEstiloso}>
          ...
          todos os conhecimentos adquiridos durante o curso. Nossa formatura é
          no dia 04 de agosto de 2023. Gostária de saber mais sobre todo o nosso
